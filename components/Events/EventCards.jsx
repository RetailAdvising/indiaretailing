    ...
    return (
        <>
            {data && data.map((res, index) => {
                ...
                return (
                    <div className={` flex flex-col rounded-[10px] lg:h-[400px] md:h-[410px] border cursor-pointer ${flex}`} onClick={() => router.push(`/${router.asPath.split('/')[1]}/${res.route}`) } key={index}>
                        <div className={``} >
                        ...
                        <div className={`flex flex-col p-[10px] h-full justify-between`}>
                            ...
                            <div className={`flex gap-[5px] items-center pt-[5px]`}>
                                ...
                                <p className={`flex flex-wrap items-center gap-[5px]`}><Image src={'/location.svg'} objectFit='contain' height={15} width={20} alt={res.title} /> 
                            ...
                            <div className='flex items-center gap-[5px] pt-[5px]'><p className={`primary_text font-semibold capitalize `}>Register Now</p><Image src={'/arrowrightprimary.svg'} className='p-0.5 right-arrow' height={6} width={12} alt={'res.title'} /></div>
                        </div>
                    </div>
                )
            })}
