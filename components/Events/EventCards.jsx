        ...
        <>
            {data && data.map((res, index) => {
                ...
                return (
                    ...
                    <Link className={` flex flex-col rounded-[10px] ${card ? card : 'md:min-h-[300px] lg:min-h-[370px]'} border cursor-pointer ${flex}`} href={`/${router.asPath.split('/')[1]}/${res.route}` } key={index}>
                        <div className={``} >
