  ...
  return (
    <>
      {profileInfo.map((res, index) => {
        return (
          <div onClick={()=>{clickTogo(res,index)}} className={`${res.selected == 1 ? 'lg:bg-slate-100 lg:text-black' : null} flex items-center rounded-[10px] p-[10px] cursor-pointer gap-[10px] lg:hover:bg-slate-100 lg:hover:text-black mb-[5px]`} key={index} >
