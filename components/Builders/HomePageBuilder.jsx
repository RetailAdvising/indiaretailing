                    ...
                    return (
                        <div key={index} className={`${res.class == 'flex-[0_0_calc(100%_-_0px)]' ? 'w-full' : res.class} `}>
                            {(res.components && res.components.length != 0) && res.components.map(c => {
                                return (
                                    <div key={c.component_title} className={`${c.component_title == "Top 3 Stories" ? 'top3' : ''}`}>
                                        ...
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Web specials") && <>
                                            ...
                                            <div className={`lg:flex gap-5`}>
                                                ...
                                                <div><AdsBaner data={{ ad_image: '/ads_baner.png' }} height={'h-[280px]'} width={'w-[330px]'} /></div>
                                            </div>
                                        ...
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "IR Video Wall") && <>
                                            ...
                                            <><Video data={data.data[c.cid].data} isHome={'/ir/'} isBg={true} imgClass={'h-[200px] w-full'} /></>
                                        </>}
                                        ...
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Fashion & Lifestyle") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={`flex gap-5 flex-wrap`}><List isHome={'/categories/'} imgFlex={'flex-[0_0_calc(40%_-_10px)]'} data={data.data[c.cid].data} check={true} flex={'flex-[0_0_calc(50%_-_10px)] md:flex-[0_0_calc(100%_-_10px)]'} imgWidth={"h-[160px]"} imgHeight={"w-[215px]"} borderRadius={"rounded-[10px]"} /></div>
                                        </>}
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Beauty & Wellness") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={`border p-[10px] rounded-[5px]`}><List isHome={'/categories/'} imgFlex={'flex-[0_0_calc(25%_-_10px)]'} data={data.data[c.cid].data} check={true} imgWidth={"w-[100px]"} imgHeight={"h-[60px]"} borderRadius={"rounded-[10px]"} isTop={true} isBB={true} /></div>
                                        </>}

                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Food & Beverage") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={`flex gap-5 justify-between flex-wrap`}><Cards cardClass={"h-[300px]"} check={true} data={data.data[c.cid].data} borderRadius={"rounded-[10px_10px_0_0]"} height={"h-[180px]"} width={"w-full"} flex={'flex-[0_0_calc(20%_-_20px)] md:flex-[0_0_calc(50%_-_20px)]'} isBorder={true} /></div>
                                        </>}
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && (c.component_title == "E-Commerce" || c.component_title == "People" || c.component_title == "D2C Buzz")) && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={`border p-[10px] rounded-[5px]`}><List check={true} imgFlex={'flex-[0_0_calc(40%_-_10px)]'} data={data.data[c.cid].data} imgWidth={"w-[164px]"} imgHeight={"h-[144px]"} borderRadius={"rounded-[10px]"} /></div>
                                        </>}
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Shopping Centers") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={``}><List imgFlex={'flex-[0_0_calc(20%_-_10px)]'} data={data.data[c.cid].data} check={true} fullWidth={true} imgWidth={"w-full"} imgHeight={"h-[144px]"} borderRadius={"rounded-[10px]"} /></div>
                                        </>}
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Podcast") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={`mb-[20px]`}><List data={data.data[c.cid].data} imgWidth={"w-[60px]"} imgHeight={"h-[50px]"} check={true} isBB={true} borderRadius={"rounded-[10px]"} /></div>
                                        </>}
                                        ...
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && (c.component_title == "Supply Chain" || c.component_title == "Marketing")) && <>
                                            <Title data={{ title: c.component_title }} />
                                            <><List data={data.data[c.cid].data} check={true} imgFlex={'flex-[0_0_calc(40%_-_10px)]'} imgWidth={"w-[185px]"} imgHeight={"h-[156px]"} borderRadius={"rounded-[10px]"} /></>
                                        </>}
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Technology") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={'border p-[10px] rounded-[5px]'}><List check={true} data={data.data[c.cid].data} imgFlex={'flex-[0_0_calc(25%_-_10px)]'} imgWidth={"w-[100px]"} imgHeight={"h-[75px]"} isBB={true} isTop={true} borderRadius={"rounded-[10px]"} /></div>
                                        </>}
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Case Studies") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={`flex gap-5`}><Cards check={true} data={data.data[c.cid].data} cardClass={"h-[300px]"} borderRadius={"rounded-[10px_10px_0_0]"} height={"h-[180px]"} width={"w-full"} flex={'basis-1/3'} isBorder={true} /></div>
                                        </>}
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Photo Essays") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className='photo'><MultiCarousel perView={2} check={true} cardHeight={'h-[300px]'} data={data.data[c.cid].data} height={"h-[175px]"} width={'w-full'} type={'card'} /></div>
                                        </>}
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "IMAGES Group Events") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className='flex gap-5'>
                                                <div className={`flex-[0_0_calc(30%_-_10px)]`}><ImageGroupEvents data={data.data[c.cid].data.slice(0, 1)} height={"h-[80%]"} width={"w-[80%]"} /></div>
                                                <div className={`flex flex-wrap p-[30px_0px] gap-[10px_20px]`}><EventList check={false} data={data.data[c.cid].data.slice(1, 7)} height={"h-[180px]"} width={"w-full"} flex={'flex-[0_0_calc(50%_-_10px)] md:flex-[0_0_calc(100%_-_10px)]'} isHome={true} imageBackground={"#f7f7f7"} /></div>
                                            </div>
                                        </>}
                                        {/* {(resp.component_title == "Card" && resp.component_type == "card3" && resp.data) && <>
                                            <Title data={resp.data} />
                                        ...
                                        {(c.cid && data.data[c.cid] && data.data[c.cid].data && c.component_title == "Reconnect") && <>
                                            <Title data={{ title: c.component_title }} />
                                            <div className={`flex flex-wrap gap-5 justify-between`}><Cards check={true} flex={'flex-[0_0_calc(25%_-_20px)] md:flex-[0_0_calc(50%_-_10px)]'} data={data.data[c.cid].data} borderRadius={"rounded-[10px_10px_0_0]"} height={"h-[200px]"} width={"w-full"} isBorder={true} /></div>
                                        </>}
                                        {/* {(resp.component_title == "AdsBaner" && resp.component_type == "Adbike" && resp.data) && <div className='pt-[30px]'><AdsBaner Class={'flex pt-[10px] flex-col justify-center items-center'} height={"h-full"} width={'w-full'} data={resp.data} /></div>} */}
