...
const SpeakerCard = ({ data }) => {
  return (
    <div className='relative flex flex-col lg:flex-row gap-3 w-fit'>
      <div className='flex-shrink-0'>
        <ImageLoader src={data.profile_image} style="h-[92px] w-[90px] rounded-xl" />
      ...
      <div className='flex flex-col justify-between pb-[5px]'>
        <div>
          <p className={`md:text-[14px] lg:text-[16px] font-medium ${inter.className}`}>
            {data.name1}
          </p>
          <p className='md:text-[12px] lg:text-[14px] text-[#666666] font-normal'>
            {data.designation}
          </p>
        </div>
