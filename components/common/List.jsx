...
export default function List({ imgFlex,hash_bg, contentWidth,primary_pb, line, data,titleClamp ,check, isTop, isReverse, borderRadius, imgHeight, imgWidth, isBB, flex, fullWidth, noWidth, tittleOnly, isHome = undefined,isDesc,descLine,mb }) {
