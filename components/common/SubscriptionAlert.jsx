...
export default function SubscriptionAlert() {
    ...
    return (
        <>
            <div className='flex items-center gap-5  rounded-[10px] h-[500px] my-5 p-[40px] shadow-[rgba(0,0,0,0.04)_0px_4px_12px]'>
                ...
                <div className='flex-[0_0_calc(70%_-_10px)]'>
                    <div className="rounded-full justify-center flex gap-[10px] p-[10px] mb-[10px] items-center bg-[#ddd] w-[60%]">
                        <p className="text-[16px]">Already subscribed to Prime </p>
                        <div onClick={show} className='flex cursor-pointer items-center gap-[5px]'>
                            <span className="text-red text-[16px]">Login</span>
                            <Image className='img h-[15px] w-[15px] object-contain' src={'/arrowrightprimary.svg'} height={15} width={15} alt='signup' />
                        </div>
                    </div>

                    <div className='m-[10px]'>
                        <h1 className='font-semibold text-[28px]'>Unblock this article by subscribing to Prime</h1>
                        <h4 className='font-semibold text-[20px] my-[10px]'>With this subscription you also get:</h4>
                        <div className='flex items-center py-[10px] gap-[10px]'>
                            <Image src={'/irprime/list-check-ir.svg'} height={20} width={20} alt='' />
                            <p>Access to 5000+ paywall stories written by experts</p>
                        </div>
                        {/* <p>Access to daily digital TOI Paper in an easy-to-navigate format</p> */}
                        <div className='flex items-center py-[10px] gap-[10px]'>
                            <Image src={'/irprime/list-check-ir.svg'} height={20} width={20} alt='' />
                            <p>Access to Times Assist: your team of AI assistants**</p>
                        </div>
                        <div className='flex items-center py-[10px] gap-[10px]'>
                            <Image src={'/irprime/list-check-ir.svg'} height={20} width={20} alt='' />
                            <p>Access to 6 weekly Newsletters including Gender+, Health+ Wealth+</p>
                        </div>
                    </div>
