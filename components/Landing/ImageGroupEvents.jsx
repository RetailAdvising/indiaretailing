                    ...
                    <Link key={index} href={'/' + res.route }>
                        <div className={`imageGroup h-full`} >
                            ...
                            <div className={`pt-[10px]`}>
                                ...
                                <div className={`flex gap-[10px] items-center pt-[5px]`}><h6 className={`font-[700] text-[16px] flex-[0_0_calc(70%_-_10px)] capitalize line-clamp-2 ${nunito.className}`}>{res.title} </h6>
