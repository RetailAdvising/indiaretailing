            ...
            {data && <div className='relative pb-[20px]'>
                <Link href={'/news/' + data.route}>
                    ...
                    <div className='absolute bottom-[40px] md:bottom-[15px] left-[10px] ml-2'>
                        {data.primary_text && <div className=''><button className='text-white h-[35px]  p-[0_10px] text-[13px]' style={{ background: 'linear-gradient(305deg, #F92A28 27.00%, #DA1752 100%, #FFF 100%)' }}>{data.primary_text}</button></div>}
