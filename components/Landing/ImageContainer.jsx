        ...
        <>
            {data && <div className='relative pb-[20px]'>
                <Link href={'/' + data.route}>
                    <Image width={530} loading="lazy" blurDataURL={'/empty_state.svg'} placeholder='blur' className={`rounded-[5px] ${height} ${width}`} alt="image.." src={check_Image(data.thumbnail_imagee ? data.thumbnail_imagee : data.image)} height={329} />
