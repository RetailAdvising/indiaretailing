            ...
            {data && data.slice(0, 3).map((res, index) => {
                return (
                    <Link key={index} href={'/' + res.route} className='flex-[0_0_calc(30%_-_10px)] flex gap-[10px]  items-center h-[100px] px-[10px]  rounded-[5px] bg-white  md:h-[90px] md:flex-[0_0_calc(85%_-_10px)]'>
                        ...
                        {/* <div > */}
                        <div className='flex-[0_0_calc(25%_-_10px)]  md:h-[70px] md:flex-[0_0_calc(35%_-_10px)]'>
                            <ImageLoader style={`rounded-[5px] h-[75px] md:h-[70px] w-full`} src={res.thumbnail_image ? res.thumbnail_image : res.image} title={res.title} />
