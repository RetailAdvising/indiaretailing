    ...
    return (
        <>
            {data && data.slice(0, 4).map((res, index) => {
                return (
                    <Link key={index} href={'/' + res.route} className='flex-[0_0_calc(25%_-_10px)] flex gap-[10px] justify-between items-center h-[85px] px-[10px]  rounded-[5px] bg-white  md:h-[85px] md:flex-[0_0_calc(85%_-_10px)]'>
                        ...
                        {/* <div > */}
                        <div className='flex-[0_0_calc(33%_-_5px)]  md:h-[70px] md:flex-[0_0_calc(33%_-_10px)]'>
                        ...
                        {/* </div> */}
                        <div className='lg:flex-[0_0_calc(67%_-_5px)]'>
