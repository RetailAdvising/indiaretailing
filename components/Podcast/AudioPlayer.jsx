...
function AudioPlayer(data) {
  return (
    <div className="border p-[20px_30px] flex md:p-[10px]">
      <div className="w-[30%]">
        <Image height={220} width={200} className={`rounded-[5px] float-right pr-[65px] h-[220px] w-[80%] md:w-[100%] md:h-[130px] md:pr-[5px]`} src={check_Image(data.data.image)} alt={"cards"} />
      </div>
      <div className="w-[70%]">
