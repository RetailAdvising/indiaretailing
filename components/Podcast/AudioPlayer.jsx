  ...
  return (
    <div className="border p-[20px_30px] flex md:p-[10px] md:block">
      <div className="w-[30%] md:w-[100%]">
        <Image height={220} width={200} className={`rounded-[5px] float-right pr-[65px] h-[220px] w-[80%] md:w-[100%] md:h-[180px] md:pr-[5px]`} src={check_Image(data.data.image)} alt={"cards"} />
      </div>
