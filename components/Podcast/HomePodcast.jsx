                        ...
                        {/* <div> */}
                            {(data.data) && <>
                                ...
                                <div className={`md:flex gap-[15px]  no_scroll grid grid-cols-5 w-full`}>
                                    <Cards isHome={'/podcast/'} data={isLanding ? data.data.slice(0,5) : data.data} check={true} border_none={true} width={'w-[100%]'} height={'h-[220px]'} flex={'flex-[0_0_calc(20%_-_10px)] md:flex-[0_0_calc(70%_-_10px)]'} />
                                </div>
                            </>
                            }
                        {/* </div> */}
