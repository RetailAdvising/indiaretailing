                ...
                <div className={`container md:py-[15px] lg:p-[20px_0]`}>
                    <div class="lg:flex lg:gap-[15px] md:block">
                                        ...
                                        return (
                                            <div key={index} className={`md:flex-[0_0_calc(70%_-_10px)] cursor-pointer border-b-[4px] border-[#f1f1f1] md:mb-[15px] md:pb-[15px]`}>
                                                <div className='flex justify-between items-center'>
                                                    ...
                                                    {icons && <div className={`px-[10px]`}><Dropdowns updateShare={(data) => updateShare(data)} btnClass={'md:w-[32px]'} share={true} link={res} width={'w-[170px]'} type={'tag'} data={icons} /></div>}

                                                </div>
                                                <h6 onClick={() => router.push('/' + res.route)} className={`title line-clamp-2 md:p-[10px] lg:py-[10px] ${nunito.className}`}>{res.title}</h6>
                        ...
                        <div class="lg:flex-[0_0_calc(30%_-_10px)] md:hidden">
                            ...
                            <Advertisement data={null} insStyle={"display:inline-block;width:300px;height:250px;"} position={"small"} divClass={`h-[250px] w-[300px] m-auto`} />
                        </div>
