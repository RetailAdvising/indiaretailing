      ...
      <RootLayout ad_payload={{ page: 'Books', page_type: 'Landing' }} homeAd={ads_data ? ads_data : null} adIdH={'book-head'} adIdF={'book-foot'} >
        ...
        {(data && data.length != 0) && <>
          ...
          {(data[1] && data[2]) && <div className='lg:items-baseline container md:p-[10px_15px_10px_15px] pt-[2rem] pb-[6rem] md:flex-wrap md:flex-col flex justify-between gap-[15px]'>
            <div className={`flex-[0_0_calc(80%_-_10px)] md:flex-[0_0_calc(100%_-_0px)]`}>
              ...
              <div className='lg:flex-[0_0_calc(70%_-_10px)] lg:rounded-[5px] lg:border lg:border-slate-200 lg:p-[15px]'>
                <div className={`grid gap-[20px] grid-cols-4 md:grid-cols-2`}><Card imgClass={'lg:h-[300px] md:h-[225px] mouse aspect-[2/2.5]'} category={data[1].route} check={true} isLanding={true} data={data[1].products.slice(0, 8)} boxShadow={true} /></div>
            ...
            <div className={`flex-[0_0_calc(20%_-_10px)] md:pt-[10px] md:flex-[0_0_calc(100%_-_10px)]`}>
              ...
              <div className={`grid gap-[20px] grid-cols-1 md:grid-cols-2 lg:rounded-[5px] lg:border lg:border-slate-200 lg:p-[15px]`}><Card imgClass={'lg:h-[300px] md:h-[225px] mouse aspect-[2/2.5]'} category={data[2].category_name} check={true} isLanding={true} data={data[2].products.slice(0, 2)} boxShadow={true} /></div>
