          ...
          {values.map((res, index) => {
            return (
              <div id={'div' + index} key={index} className='box'>
                ...
                <div className="md:hidden my-5 lg:grid lg:justify-center"><Advertisement data={advertisement && advertisement.footer && advertisement.footer} divClass={'h-[90px] w-[500px] m-auto'} insStyle={"display:inline-block;width:500px;height:90px;"} /></div>
