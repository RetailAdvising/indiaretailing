          ...
          {values.map((res, index) => {
            return (
              <div id={'div' + index} key={index} className='box'>
                ...
                <div className="md:hidden my-5 lg:grid lg:justify-center"><Advertisement data={(advertisement && advertisement.footer) ? advertisement.footer : null } divClass={'h-[90px] w-[728px] m-auto'} insStyle={"display:inline-block;width:728px;height:90px;"} /></div>
